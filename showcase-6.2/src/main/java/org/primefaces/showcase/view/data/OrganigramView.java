...
/*     */ {
	...
	/*     */ public void init() {
		...
		/*     */
		/*     */
		/* 55 */ OrganigramNode softwareDevelopment = addDivision(this.rootNode, "Software Development",
				new String[] { "Ridvan Agar" });
		/*     */
	...
	/*     */ protected OrganigramNode addDivision(OrganigramNode parent, String name, String... employees) {
		...
		/* 80 */ if (employees != null) {
			/* 81 */ for (String employee : employees) {
				/* 82 */ DefaultOrganigramNode defaultOrganigramNode1 = new DefaultOrganigramNode("employee", employee,
						(OrganigramNode) defaultOrganigramNode);
	...
	/*     */ public void nodeDragDropListener(OrganigramNodeDragDropEvent event) {
		...
		/* 93 */ message.setSummary("Node '" + event.getOrganigramNode().getData() + "' moved from "
	...
	/*     */ public void addEmployee() {
		...
		/*     */
		/* 139 */ DefaultOrganigramNode defaultOrganigramNode = new DefaultOrganigramNode("employee", this.employeeName,
				currentSelection);
 ...
 * view\data\OrganigramView.class Java compiler version: 6 (50.0) JD-Core
 * Version: 1.1.3
 */