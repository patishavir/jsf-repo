...
/*     */ {
	/* 35 */ private static final List<String> VALID_COLUMN_KEYS = Arrays
			.asList(new String[] { "id", "brand", "year", "color", "price" });
	/*     */
 ...
 * view\data\datatable\ColumnsView.class Java compiler version: 6 (50.0) JD-Core
 * Version: 1.1.3
 */