...
/*    */ {
	/* 34 */ private MindmapNode root = (MindmapNode) new DefaultMindmapNode("google.com", "Google WebSite", "FFCC00",
			false);
	...
	/*    */ public MindmapView() {
		...
		/* 38 */ DefaultMindmapNode defaultMindmapNode3 = new DefaultMindmapNode("Malware", "Malicious Software",
				"6e9ebf", true);
		/*    */
		...
		/* 60 */ if (node.getChildren().isEmpty()) {
			...
			/* 63 */ if (label.equals("NS(s)")) {
				/* 64 */ for (int i = 0; i < 25; i++) {
					/* 65 */ node.addNode((MindmapNode) new DefaultMindmapNode("ns" + i + ".google.com",
							"Namespace " + i + " of Google", "82c542", false));
					/*    */ }
				/*    */ }
			/* 68 */ else if (label.equals("IPs")) {
				/* 69 */ for (int i = 0; i < 18; i++) {
					/* 70 */ node.addNode((MindmapNode) new DefaultMindmapNode("1.1.1." + i, "IP Number: 1.1.1." + i,
							"fce24f", false));
					/*    */ }
				/*    */ }
			/* 73 */ else if (label.equals("Malware")) {
				/* 74 */ for (int i = 0; i < 18; i++) {
					...
					/* 76 */ node.addNode((MindmapNode) new DefaultMindmapNode("Malware-" + random,
							"Malicious Software: " + random, "3399ff", false));
					/*    */ }
				/*    */ }
			/*    */ }
		/*    */ }
 ...
 * view\data\MindmapView.class Java compiler version: 6 (50.0) JD-Core Version:
 * 1.1.3
 */