...
/*    */ {
	...
	/*    */ public void init() {
		...
		/*    */
		/* 38 */ this.movieList
				.add(new Movie("The Lord of the Rings: The Two Towers", "Peter Jackson", "Fantasy, Epic", 179));
		...
		/* 43 */ this.movieList.add(
				new Movie("The Lord of the Rings: The Fellowship of the Ring", "Peter Jackson", "Fantasy, Epic", 165));
		...
		/* 49 */ this.movieList
				.add(new Movie("The Lord of the Rings: The Return of the King", "Peter Jackson", "Fantasy, Epic", 200));
		/*    */ }
	/*    */ }
 ...
 * view\overlay\MovieView.class Java compiler version: 6 (50.0) JD-Core Version:
 * 1.1.3
 */