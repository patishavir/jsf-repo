...
/*     */ {
	...
	/*     */ public void init() {
		...
		/* 55 */ g1.setSelectItems(new SelectItem[] { new SelectItem("BMW", "BMW"),
		...
		/* 58 */ g2.setSelectItems(new SelectItem[] { new SelectItem("Chrysler", "Chrysler"),
 ...
 * view\input\SelectOneMenuView.class Java compiler version: 6 (50.0) JD-Core
 * Version: 1.1.3
 */