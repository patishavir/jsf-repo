...
/*     */ {
	...
	/*     */ public void init() {
		...
		/* 50 */ this.eventModel.addEvent((ScheduleEvent) new DefaultScheduleEvent("Champions League Match",
				previousDay8Pm(), previousDay11Pm()));
		/* 51 */ this.eventModel
				.addEvent((ScheduleEvent) new DefaultScheduleEvent("Birthday Party", today1Pm(), today6Pm()));
		/* 52 */ this.eventModel.addEvent(
				(ScheduleEvent) new DefaultScheduleEvent("Breakfast at Tiffanys", nextDay9Am(), nextDay11Am()));
		/* 53 */ this.eventModel.addEvent((ScheduleEvent) new DefaultScheduleEvent("Plant the new garden stuff",
	...
	/*     */ public void onDateSelect(SelectEvent selectEvent) {
		/* 190 */ this.event = (ScheduleEvent) new DefaultScheduleEvent("", (Date) selectEvent.getObject(),
				(Date) selectEvent.getObject());
		/*     */ }

	/*     */
	/*     */ public void onEventMove(ScheduleEntryMoveEvent event) {
		/* 194 */ FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Event moved",
	...
	/*     */ public void onEventResize(ScheduleEntryResizeEvent event) {
		/* 200 */ FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Event resized",
				"Day delta:" + event.getDayDelta() + ", Minute delta:" + event.getMinuteDelta());
		/*     */
 ...
 * view\data\ScheduleView.class Java compiler version: 6 (50.0) JD-Core Version:
 * 1.1.3
 */