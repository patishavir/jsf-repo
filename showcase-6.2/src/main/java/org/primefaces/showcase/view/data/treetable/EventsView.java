...
/*    */ {
	...
	/*    */ public void onNodeExpand(NodeExpandEvent event) {
		/* 65 */ FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Expanded",
	...
	/*    */ public void onNodeCollapse(NodeCollapseEvent event) {
		/* 70 */ FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Collapsed",
				event.getTreeNode().toString());
	...
	/*    */ public void onNodeSelect(NodeSelectEvent event) {
		/* 75 */ FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Selected",
				event.getTreeNode().toString());
	...
	/*    */ public void onNodeUnselect(NodeUnselectEvent event) {
		/* 80 */ FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Unselected",
				event.getTreeNode().toString());
 ...
 * view\data\treetable\EventsView.class Java compiler version: 6 (50.0) JD-Core
 * Version: 1.1.3
 */