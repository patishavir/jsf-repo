...
/*    */ {
	...
	/*    */ public void addMarker() {
		...
		/* 77 */ FacesContext.getCurrentInstance().addMessage(null,
				new FacesMessage(FacesMessage.SEVERITY_INFO, "Marker Added", "Lat:" + this.lat + ", Lng:" + this.lng));
		/*    */ }
	/*    */ }
 ...
 * view\data\gmap\AddMarkersView.class Java compiler version: 6 (50.0) JD-Core
 * Version: 1.1.3
 */