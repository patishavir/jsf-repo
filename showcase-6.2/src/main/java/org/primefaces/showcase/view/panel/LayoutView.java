...
/*    */ {
	/*    */ public void handleClose(CloseEvent event) {
		/* 30 */ FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Unit Closed",
	...
	/*    */ public void handleToggle(ToggleEvent event) {
		/* 36 */ FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO,
	...
	/*    */ public void handleResize(ResizeEvent event) {
		/* 42 */ FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO,
 ...
 * view\panel\LayoutView.class Java compiler version: 6 (50.0) JD-Core Version:
 * 1.1.3
 */