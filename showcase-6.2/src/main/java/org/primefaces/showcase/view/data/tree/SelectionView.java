...
/*     */ {
	...
	/*     */ public void displaySelectedSingle() {
		/* 90 */ if (this.selectedNode != null) {
			/* 91 */ FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Selected",
					this.selectedNode.getData().toString());
	...
	/*     */ public void displaySelectedMultiple(TreeNode[] nodes) {
		/* 97 */ if (nodes != null && nodes.length > 0) {
			...
			/* 100 */ for (TreeNode node : nodes) {
				...
				/*     */ }
			/*     */
			/* 105 */ FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Selected",
					builder.toString());
 ...
 * view\data\tree\SelectionView.class Java compiler version: 6 (50.0) JD-Core
 * Version: 1.1.3
 */