...
/*     */ {
	...
	/*     */ public void init() {
		...
		/*     */
		/* 58 */ Element computerA = new Element(new NetworkElement(this, "Computer A", "computer-icon.png"), "10em",
				"6em");
		...
		/*     */
		/* 63 */ Element computerB = new Element(new NetworkElement(this, "Computer B", "computer-icon.png"), "25em",
				"6em");
		...
		/*     */
		/* 68 */ Element computerC = new Element(new NetworkElement(this, "Computer C", "computer-icon.png"), "40em",
				"6em");
	...
	/*     */ public void onConnect(ConnectEvent event) {
		/* 97 */ if (!this.suspendEvent) {
			/*     */
			/* 99 */ FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_INFO, "Connected",
	...
	/*     */ public void onDisconnect(DisconnectEvent event) {
		/* 112 */ FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_INFO, "Disconnected",
				"From " + event.getSourceElement().getData() + " To " + event.getTargetElement().getData());
		/*     */
	...
	/*     */ public void onConnectionChange(ConnectionChangeEvent event) {
		/* 124 */ FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_INFO, "Connection Changed",
				"Original Source:" + event.getOriginalSourceElement().getData() + ", New Source: "
						+ event.getNewSourceElement().getData() + ", Original Target: "
						+ event.getOriginalTargetElement().getData() + ", New Target: "
 ...
 * view\data\diagram\EditableView.class Java compiler version: 6 (50.0) JD-Core
 * Version: 1.1.3
 */