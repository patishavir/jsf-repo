...
/*    */ {
	/* 33 */ private static final List<String> VALID_COLUMN_KEYS = Arrays
			.asList(new String[] { "name", "size", "type" });
	/*    */
 ...
 * view\data\treetable\ColumnsView.class Java compiler version: 6 (50.0) JD-Core
 * Version: 1.1.3
 */