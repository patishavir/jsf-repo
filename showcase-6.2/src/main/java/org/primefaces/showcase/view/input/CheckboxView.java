...
/*     */ {
	...
	/*     */ public void init() {
		...
		/* 51 */ germanCars.setSelectItems(new SelectItem[] { new SelectItem("BMW", "BMW"),
				new SelectItem("Mercedes", "Mercedes"), new SelectItem("Volkswagen", "Volkswagen") });
		/*     */
		/*     */
		/*     */
		/*     */
		...
		/* 58 */ americanCars.setSelectItems(new SelectItem[] { new SelectItem("Chrysler", "Chrysler"),
				new SelectItem("GM", "GM"), new SelectItem("Ford", "Ford") });
		/*     */
		/*     */
		/*     */
		/*     */
 ...
 * view\input\CheckboxView.class Java compiler version: 6 (50.0) JD-Core
 * Version: 1.1.3
 */