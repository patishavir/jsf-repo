...
/*    */ {
	...
	/*    */ public void oncapture(CaptureEvent captureEvent) {
		...
		/* 49 */ String newFileName = externalContext.getRealPath("") + File.separator + "resources" + File.separator
				+ "demo" + File.separator + "images" + File.separator + "photocam" + File.separator + this.filename
				+ ".jpeg";
		/*    */
		/*    */
		/*    */
 ...
 * view\multimedia\PhotoCamView.class Java compiler version: 6 (50.0) JD-Core
 * Version: 1.1.3
 */