...
/*    */ {
	/* 35 */ private static final String[] colors = new String[10];
	static {
		/* 36 */ colors[0] = "Black";
		/* 37 */ colors[1] = "White";
		/* 38 */ colors[2] = "Green";
		...
		/* 45 */ colors[9] = "Maroon";
		/*    */ }
	/* 47 */ private static final String[] brands = new String[10];
	static {
		/* 48 */ brands[0] = "BMW";
	...
	/*    */ public List<Car> createCars(int size) {
		...
		/* 62 */ for (int i = 0; i < size; i++) {
			/* 63 */ list.add(new Car(getRandomId(), getRandomBrand(), getRandomYear(), getRandomColor(),
 ...
 * service\CarService.class Java compiler version: 6 (50.0) JD-Core Version:
 * 1.1.3
 */