...
/*    */ {
	...
	/*    */
	/*    */ public Sale(String manufacturer, int lastYearSale, int thisYearSale, int lastYearProfit,
			int thisYearProfit) {
 ...
 * domain\Sale.class Java compiler version: 6 (50.0) JD-Core Version: 1.1.3
 */