...
/* 63 */     message.setDetail("Item index: " + event.getItemIndex() + ", Column index: " + event.getColumnIndex() + ", Sender index: " + event.getSenderColumnIndex());
/*    */     
/* 65 */     addMessage(message);
/*    */   }
/*    */   
/*    */   public void handleClose(CloseEvent event) {
/* 69 */     FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Panel Closed", "Closed panel id:'" + event.getComponent().getId() + "'");
/*    */     
/* 71 */     addMessage(message);
/*    */   }
/*    */   
/*    */   public void handleToggle(ToggleEvent event) {
/* 75 */     FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, event.getComponent().getId() + " toggled", "Status:" + event.getVisibility().name());
/*    */     
...
/* Location:              D:\oj\j\primefaces\showcase-6.2.war!\WEB-INF\classes\org\primefaces\showcase\view\panel\DashboardView.class
