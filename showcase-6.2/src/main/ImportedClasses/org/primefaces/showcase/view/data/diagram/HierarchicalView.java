...
/*    */ 
/*    */     
/* 81 */     this.model.connect(new Connection(ceo.getEndPoints().get(0), cfo.getEndPoints().get(0), (Connector)connector));
/* 82 */     this.model.connect(new Connection(ceo.getEndPoints().get(0), cto.getEndPoints().get(0), (Connector)connector));
/* 83 */     this.model.connect(new Connection(cfo.getEndPoints().get(1), fin.getEndPoints().get(0), (Connector)connector));
/* 84 */     this.model.connect(new Connection(cfo.getEndPoints().get(1), pur.getEndPoints().get(0), (Connector)connector));
/* 85 */     this.model.connect(new Connection(cto.getEndPoints().get(1), dev.getEndPoints().get(0), (Connector)connector));
/* 86 */     this.model.connect(new Connection(cto.getEndPoints().get(1), tst.getEndPoints().get(0), (Connector)connector));
/*    */   }
/*    */   
...
/* Location:              D:\oj\j\primefaces\showcase-6.2.war!\WEB-INF\classes\org\primefaces\showcase\view\data\diagram\HierarchicalView.class
