...
/* 106 */     context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Item Selected", event.getObject().toString()));
/*     */   }
/*     */   
/*     */   public void onUnselect(UnselectEvent event) {
/* 110 */     FacesContext context = FacesContext.getCurrentInstance();
/* 111 */     context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Item Unselected", event.getObject().toString()));
/*     */   }
/*     */   
...
/* Location:              D:\oj\j\primefaces\showcase-6.2.war!\WEB-INF\classes\org\primefaces\showcase\view\data\PickListView.class
