...
/*    */   @PostConstruct
/*    */   public void init() {
/* 33 */     this.categories = new ArrayList<SelectItem>();
...
/*    */     
/* 63 */     group1.setSelectItems(new SelectItem[] { (SelectItem)group11, (SelectItem)group12 });
/* 64 */     group2.setSelectItems(new SelectItem[] { (SelectItem)group21 });
...
/* Location:              D:\oj\j\primefaces\showcase-6.2.war!\WEB-INF\classes\org\primefaces\showcase\view\input\MultiSelectView.class
