...
/*  50 */     this.modelFirst.add(new TimelineEvent(new Task(this, "Mail from boss", "images/timeline/mail.png", false), cal.getTime()));
/*     */     
/*  52 */     cal.set(2015, 7, 23, 23, 0, 0);
/*  53 */     this.modelFirst.add(new TimelineEvent(new Task(this, "Call back my boss", "images/timeline/callback.png", false), cal.getTime()));
/*     */     
/*  55 */     cal.set(2015, 7, 24, 21, 45, 0);
/*  56 */     this.modelFirst.add(new TimelineEvent(new Task(this, "Travel to Spain", "images/timeline/location.png", false), cal.getTime()));
/*     */     
/*  58 */     cal.set(2015, 7, 26, 0, 0, 0);
/*  59 */     Date startWork = cal.getTime();
/*  60 */     cal.set(2015, 8, 2, 0, 0, 0);
/*  61 */     Date endWork = cal.getTime();
/*  62 */     this.modelFirst.add(new TimelineEvent(new Task(this, "Do homework", "images/timeline/homework.png", true), startWork, endWork));
/*     */     
/*  64 */     cal.set(2015, 7, 28, 0, 0, 0);
/*  65 */     this.modelFirst.add(new TimelineEvent(new Task(this, "Create memo", "images/timeline/memo.png", false), cal.getTime()));
/*     */     
/*  67 */     cal.set(2015, 7, 31, 0, 0, 0);
/*  68 */     Date startReport = cal.getTime();
/*  69 */     cal.set(2015, 8, 3, 0, 0, 0);
/*  70 */     Date endReport = cal.getTime();
/*  71 */     this.modelFirst.add(new TimelineEvent(new Task(this, "Create report", "images/timeline/report.png", true), startReport, endReport));
/*     */   }
/*     */   
...
/*     */ 
/*     */     
/* 107 */     FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_INFO, "Selected project: " + (this.aSelected ? "A" : "B"), null);
...
/* Location:              D:\oj\j\primefaces\showcase-6.2.war!\WEB-INF\classes\org\primefaces\showcase\view\data\timeline\LinkedTimelinesView.class
