/*     */ package WEB-INF.classes.org.primefaces.showcase.view.chart;
/*     */ 
...
/*  95 */     FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_INFO, "Item selected", "Item Index: " + event.getItemIndex() + ", Series Index:" + event.getSeriesIndex());
/*     */     
...
/* 473 */       this.ohlcModel2.add(new OhlcChartSeries(Integer.valueOf(i), Math.random() * 80.0D + 80.0D, Math.random() * 50.0D + 110.0D, Math.random() * 20.0D + 80.0D, Math.random() * 80.0D + 80.0D));
/*     */     }
/*     */     
...
/* Location:              D:\oj\j\primefaces\showcase-6.2.war!\WEB-INF\classes\org\primefaces\showcase\view\chart\ChartView.class
