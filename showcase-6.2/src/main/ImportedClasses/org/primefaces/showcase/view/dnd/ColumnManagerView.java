...
/*     */ {
/*  37 */   private final List<String> VALID_COLUMN_KEYS = Arrays.asList(new String[] { "id", "brand", "year", "color" });
/*     */   
...
/*  59 */     DefaultTreeNode defaultTreeNode2 = new DefaultTreeNode("column", new ColumnModel("Id", "id"), (TreeNode)defaultTreeNode1);
/*  60 */     DefaultTreeNode defaultTreeNode3 = new DefaultTreeNode("column", new ColumnModel("Year", "year"), (TreeNode)defaultTreeNode1);
/*  61 */     DefaultTreeNode defaultTreeNode4 = new DefaultTreeNode("column", new ColumnModel("Brand", "brand"), (TreeNode)defaultTreeNode1);
/*  62 */     DefaultTreeNode defaultTreeNode5 = new DefaultTreeNode("column", new ColumnModel("Color", "color"), (TreeNode)defaultTreeNode1);
/*     */   }
/*     */   
...
/*  79 */     Map<String, String> params = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap();
...
/* 103 */     Map<String, String> params = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap();
...
/*     */ 
/*     */     
/* 110 */     DefaultTreeNode defaultTreeNode = new DefaultTreeNode("column", model, this.availableColumns.getChildren().get(0));
/*     */   }
/*     */   
...
/* Location:              D:\oj\j\primefaces\showcase-6.2.war!\WEB-INF\classes\org\primefaces\showcase\view\dnd\ColumnManagerView.class
