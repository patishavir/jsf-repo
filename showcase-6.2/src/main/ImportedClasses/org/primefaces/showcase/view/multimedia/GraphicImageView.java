...
/* 52 */       this.graphicText = (StreamedContent)new DefaultStreamedContent(new ByteArrayInputStream(os.toByteArray()), "image/png");
/*    */ 
/*    */       
...
/* 58 */       this.chart = (StreamedContent)new DefaultStreamedContent(new FileInputStream(chartFile), "image/png");
/*    */     }
...
/* Location:              D:\oj\j\primefaces\showcase-6.2.war!\WEB-INF\classes\org\primefaces\showcase\view\multimedia\GraphicImageView.class
