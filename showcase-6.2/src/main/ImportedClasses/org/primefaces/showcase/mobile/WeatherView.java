...
/* 40 */   private static final Logger logger = Logger.getLogger(org.primefaces.showcase.mobile.WeatherView.class.getName());
/*    */   
/*    */   @PostConstruct
/*    */   public void init() {
...
/*    */     try {
/* 80 */       URL feedSource = new URL("http://weather.yahooapis.com/forecastrss?p=" + this.city + "&u=" + this.unit);
...
/* Location:              D:\oj\j\primefaces\showcase-6.2.war!\WEB-INF\classes\org\primefaces\showcase\mobile\WeatherView.class
